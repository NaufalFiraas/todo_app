      ...
      when(() => dbHelper.getData(null)).thenAnswer((_) => Future.value([
            {
              ...
              'title': 'title test',
              'description': 'description test',
              'date': date.add(const Duration(days: 7)).toIso8601String(),
              'hour': 17,
              'minute': 25,
              'category': 'category test',
              'isFinished': 0,
            },
            {
              ...
              'date': date.add(const Duration(days: 4)).toIso8601String(),
              'hour': 18,
              'minute': 26,
            ...
            },
            {
              ...
              'title': 'title1 test',
              'description': 'description1 test',
              'date': date.add(const Duration(days: 30)).toIso8601String(),
              'hour': 18,
              'minute': 26,
              'category': 'category1 test',
              'isFinished': 1,
